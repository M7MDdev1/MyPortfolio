...
export default function Expertise() {
  return (
    <div className="mx-20 mb-7">
      <h1
        className={
          "text-[#282938] font-semibold text-2xl sm:text-[4rem] font-playfair sm:mb-24 mb-6 -translate-x-14 sm:translate-x-0"
        }
      >
        My Expertise
      </h1>
      ...
      <div
        className={
          "flex justify-around flex-col sm:flex-row items-center gap-y-9 sm:gap-y-0"
        }
      >
        <ExpertiseCard
          img={"/CardImages/Strategy & Direction.png"}
        ...
        <ExpertiseCard
          img={"/CardImages/Branding & Logo.png"}
          Title={"Branding & Logo"}
        ...
        <ExpertiseCard
          img={"/CardImages/UI & UX Design.png"}
          Title={"UI & UX Design"}
